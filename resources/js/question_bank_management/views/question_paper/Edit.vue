            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex flex-wrap justify-content-between">
                        <h4 class="text-capitalise">Edit Question Paper</h4>
                        <ul>
                            <li>
                            ...
                            <div class="col-12">
                                <div style="max-width: 220px;margin:auto;">
                                    <form class="d-flex" action="" @submit.prevent="search_data">
                                        ...
                                        <button class="btn ms-3 btn-outline-secondary"><i class="fa fa-search"></i></button>
                                    </form>
                                </div>
                            </div>

                            <div class="col-12 table-responsive">
                                <label id="selected_question" class="text-capitalize">Select Question</label>
                                <table class="table table-bordered question_list_table question_list_table_selected_for_create_paper table-hover">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>SI</th>
...
export default {
    ...
    methods: {
        ...
        get_paper_data: function(){
            axios.post('/question-bank/question-paper/get/'+this.$route.params.id)
                .then(res=>{
                    ...
                    this.get_chapters(res.data.module_id);
                    // $('#chapter_id').val([res.data.chapter_id]).trigger('change');
        ...
        store: function(event){
            ...
            axios.post('/question-bank/question-paper/update',form_data)
                .then(res=>{
                    window.s_alert('success','The question paper updated.');
