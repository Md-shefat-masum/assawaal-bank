            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-header d-flex flex-wrap justify-content-between">
                        <h4 class="text-capitalise">Import Chapter</h4>
                        <ul>
                            <li>
                    ...
                    <div class="card-body">
                        <form action="#" @submit.prevent="get_file($event.target)" enctype="multipart/form-data">
                            ...
                            <div class="text-center">
                                <a href="/csv_sample/chapter.csv" download="" target="_black" class="btn btn-success mx-2">
...
export default {
    ...
    methods: {
        get_file: function(event){
            ...
            axios.post('/question-bank/chapter/load-csv',form_data)
                .then(res=>{
                    this.data = res.data;
                })
                .catch(err=>{
        ...
        store: function(){
            if(window.confirm('confirm??')){
                axios.post('/question-bank/chapter/store_csv',{data: this.data})
                    .then(res=>{
